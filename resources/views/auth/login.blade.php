...
@section('body')
    <div class="fondo-secundario center-content">
        <div class="login-contenedor bg-slate-100 rounded-md border-cyan-700 p-3">
            <div class="login__logo flex justify-center">
                <img class="w-6/12" src="{{ asset('img/logo.webp') }}" alt="logo">
            </div>
            <form action="" class="login__form flex flex-col gap-6 w-12/12 mt-4">
