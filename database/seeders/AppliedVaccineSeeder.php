    ...
    public function run(): void
    {
        DB::table('applied_vaccines')->insert([
            [
                ...
                'historias_clinica_id' => 1 // Asegúrate de que estos IDs existan en la tabla 'historia_clinica'
            ],
            [
